...
<section class="content">
    <div class="card card-solid">
                        ...
                        <div class="card-body">
                            <ul class="list-group list-group-unbordered mb-3">
                                <li class="list-group-item">
                                    <b>Mailing Address</b>
                                    <p><?php echo e($investor->mailing_address); ?></p>
                                </li>
                                <li class="list-group-item">
                                    <b>Office Address</b>
                                    <p><?php echo e($investor->address); ?></p>
                                </li>
                                <li class="list-group-item">
                                    <b>Permanent Address</b>
                                    <p><?php echo e($investor->peraddress); ?></p>
                                </li>
                            </ul>
                        </div>
                    </div>
        ...
        <div class="row no-print">
            <div class="col-12">
                <a type="button" class="btn btn-primary float-right" style="margin-right: 5px;" href="<?php echo e(route('admin.investor.generateInvoice', $investor->iid)); ?>"><i class="fas fa-download"></i>Print Invoice</a>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\mangrove-hotel\resources\views/admin/investors/show.blade.php ENDPATH**/ ?>