                ...
                <div class="invoice p-5 mb-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-8">
                            ...
                            <img style="width:30px;" src="<?php echo e(asset( 'backend/img/money.png')); ?>" alt="Cash" />
                            <img style="width:30px;" src="<?php echo e(asset( 'backend/img/money.png')); ?>" alt="B" />
                            <img style="width:30px;" src="<?php echo e(asset( 'backend/img/money.png')); ?>" alt="" />
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mangrovehotel/dev.mangrove-hotel.com/resources/views/admin/investor_list.blade.php ENDPATH**/ ?>