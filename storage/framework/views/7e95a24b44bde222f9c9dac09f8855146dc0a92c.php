...
<head>
    ...
    <meta name="viewport" content="user-scalable=no, width=device-width, target-densityDpi=device-dpi" />
        <!-- Styles -->
    <link rel="stylesheet" href="<?php echo e(asset('front/css/jquery.scrollbar.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('front/css/swiper.min.css')); ?>">
...
/*logi Form*/
    ...
    <!-- Fonts -->
    <link rel="stylesheet" type="text/css" media="screen" href="<?php echo e(asset('front/fonts/custom-fonts.css')); ?>" />
...
<body>
    <div id="app">
        <div class="main-menu d-flex justify-content-between flex-wrap align-items-center">
            ...
            <ul id="menu">
                <li data-menuanchor="Overview">
                    <a class="link-1" href="<?php echo e(url('/')); ?>#Overview">Overview</a>
                    <span></span>
                </li>
                <li data-menuanchor="Modernliving">
                    <a class="link-2" href="<?php echo e(url('/')); ?>#Modernliving">Modernliving</a>
                    <span></span>
                </li>
                <li data-menuanchor="Gallery">
                    <a class="link-3" href="<?php echo e(url('/')); ?>#Gallery">Gallery</a>
                    <span></span>
                </li>
                <li data-menuanchor="Map">
                    <a class="link-4" href="<?php echo e(url('/')); ?>#Map">Map</a>
                    <span></span>
                </li>
                <li data-menuanchor="Login">
                    <a class="link-5" href="<?php echo e(url('/')); ?>#Login">Login</a>
                    <span></span>
                </li>
            </ul>
        </div> <!-- header menu-->
        ...
        <header class="header">
            ...
            <div class="invesment">
                <a href="<?php echo e(route('registration')); ?>"><span>invesment</span></a>
            </div>
    ...
    <script src="<?php echo e(asset('front/js/pagepiling.min.js')); ?>"></script>
    <script src="<?php echo e(asset('front/js/js.js')); ?>"></script>
...
<?php /**PATH /home/vagrant/dev.mangrove-hotel/resources/views/layouts/app.blade.php ENDPATH**/ ?>