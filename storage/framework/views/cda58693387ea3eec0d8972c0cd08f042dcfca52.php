                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-body box-profile">
                            <div class="text-center">
                                ...
                                $profile_picture = asset("storage/".$investor->picture);
                                }else{
                                $profile_picture = asset( 'backend/img/user7-128x128.jpg');
                                }
                                ?>

                                <img class="profile-user-img img-fluid img-circle" src="<?php echo e($profile_picture); ?>"
...
<!-- /.content -->
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mangrovehotel/dev.mangrove-hotel.com/resources/views/admin/investors/show.blade.php ENDPATH**/ ?>