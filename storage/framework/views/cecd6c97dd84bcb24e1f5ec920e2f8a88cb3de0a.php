                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::text('address[Office][division_id]', null, array('class' => "form-control",'id'=>'','placeholder'=>'Division', 'required' => 'required', 'maxlength' => '150'))); ?>


                                        <?php if($errors->has('address[Office][division_id]')): ?>
                                            <span class="text-danger"><?php echo e($errors->first('address[Office][division_id]')); ?></span>
                                        <?php endif; ?>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::text('address[Office][district_id]', null, array('class' => "form-control",'id'=>'','placeholder'=>'District', 'required' => 'required', 'maxlength' => '150'))); ?>


                                        <?php if($errors->has('address[Office][district_id]')): ?>
                                            <span class="text-danger"><?php echo e($errors->first('address[Office][district_id]')); ?></span>
                                        <?php endif; ?>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::text('address[Office][thana_id]', null, array('class' => "form-control",'id'=>'','placeholder'=>'Thana', 'required' => 'required', 'maxlength' => '150'))); ?>


                                        <?php if($errors->has('address[Office][thana_id]')): ?>
                                            <span class="text-danger"><?php echo e($errors->first('address[Office][thana_id]')); ?></span>
                                        <?php endif; ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <label for="nid"> Division</label>
                                        <?php echo e(Form::text('address[Mailing][division_id]', null, array('class' => "form-control",'id'=>'','placeholder'=>'Division', 'required' => 'required', 'maxlength' => '150'))); ?>


                                        <?php if($errors->has('address[Mailing][division_id]')): ?>
                                            <span class="text-danger"><?php echo e($errors->first('address[Mailing][division_id]')); ?></span>
                                        <?php endif; ?>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::text('address[Mailing][district_id]', null, array('class' => "form-control",'id'=>'','placeholder'=>'Division', 'required' => 'required', 'maxlength' => '150'))); ?>


                                        <?php if($errors->has('address[Mailing][district_id]')): ?>
                                            <span class="text-danger"><?php echo e($errors->first('address[Mailing][district_id]')); ?></span>
                                        <?php endif; ?>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <label for="nid"> Thana</label>
                                        <?php echo e(Form::text('address[Mailing][thana_id]', null, array('class' => "form-control",'id'=>'','placeholder'=>'Thana', 'required' => 'required', 'maxlength' => '150'))); ?>


                                        <?php if($errors->has('address[Mailing][thana_id]')): ?>
                                            <span class="text-danger"><?php echo e($errors->first('address[Mailing][thana_id]')); ?></span>
                                        <?php endif; ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <label for="nid"> Division</label>
                                        <?php echo e(Form::text('address[Permanent][division_id]', null, array('class' => "form-control",'id'=>'','placeholder'=>'Division', 'required' => 'required', 'maxlength' => '150'))); ?>


                                        <?php if($errors->has('address[Permanent][division_id]')): ?>
                                            <span class="text-danger"><?php echo e($errors->first('address[Permanent][division_id]')); ?></span>
                                        <?php endif; ?>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <label for="nid"> District</label>
                                        <?php echo e(Form::text('address[Permanent][district_id]', null, array('class' => "form-control",'id'=>'','placeholder'=>'District', 'required' => 'required', 'maxlength' => '150'))); ?>


                                        <?php if($errors->has('address[Permanent][district_id]')): ?>
                                            <span class="text-danger"><?php echo e($errors->first('address[Permanent][district_id]')); ?></span>
                                        <?php endif; ?>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <label for="nid"> Thana</label>
                                        <?php echo e(Form::text('address[Permanent][thana_id]', null, array('class' => "form-control",'id'=>'','placeholder'=>'Thana', 'required' => 'required', 'maxlength' => '150'))); ?>


                                        <?php if($errors->has('address[Permanent][thana_id]')): ?>
                                            <span class="text-danger"><?php echo e($errors->first('address[Permanent][thana_id]')); ?></span>
                                        <?php endif; ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\mangrove-hotel\resources\views/admin/invoice/create.blade.php ENDPATH**/ ?>