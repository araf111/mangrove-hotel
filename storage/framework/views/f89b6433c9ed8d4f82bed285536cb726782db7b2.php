...
<div class="sidebar">
    ...
    <div class="user-panel mb-3 d-blok">
        <div class="image">
            ...
            <?php else: ?>
            <img src="<?php echo e(asset( 'backend/img/user2-160x160.jpg')); ?>" class="img-circle elevation-2" alt="User Image">
            <?php endif; ?>
        </div>
        <div class="info">
    ...
    <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <!-- Investor -->
            <li class="nav-item">
                <a href="<?php echo e(route('admin.investor.list')); ?>" class="nav-link">
                ...
                <ul class="nav nav-treeview">
                    ...
                    <li class="nav-item <?php if($web_content_child_menu_open): ?> menu-open <?php endif; ?> has-treeview">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="<?php echo e(route('admin.cms.gallery')); ?>"
                                    class="nav-link <?php if(fnmatch( 'admin.cms.gallery', $currentRouteName )): ?> active <?php endif; ?>">
                                    <i class="fas fa-circle nav-icon"></i>
                                    <p>Gallery</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="<?php echo e(route('admin.cms.map')); ?>"
                                    class="nav-link <?php if(fnmatch( 'admin.cms.map', $currentRouteName )): ?> active <?php endif; ?>">
                                    <i class="fas fa-circle nav-icon"></i>
                                    <p>Map</p>
                                </a>
                            </li>
...
<!-- /.sidebar --><?php /**PATH /home/mangrovehotel/dev.mangrove-hotel.com/resources/views/admin/layouts/sidebar.blade.php ENDPATH**/ ?>