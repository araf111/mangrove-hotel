                                        ...
                                        <div class="col-6">
                                            ...
                                            <div class="col-12">
                                                <form method="post" class="notGallery" action="<?php echo e(route('admin.homeSectionUpdate')); ?>" enctype="multipart/form-data">
                                                    ...
                                                    <input type="hidden" name="id" value="<?php echo e(isset($gallerySectionList['banner']['image1']['id'])?$gallerySectionList['banner']['image1']['id']:''); ?>">
                                        ...
                                        <div class="col-6">
                                            ...
                                            <div class="col-12">
                                                <form method="post" class="notGallery" action="<?php echo e(route('admin.homeSectionUpdate')); ?>" enctype="multipart/form-data">
                                                    ...
                                                    <input type="hidden" name="id" value="<?php echo e(isset($gallerySectionList['banner-text']['image1']['id'])?$gallerySectionList['banner-text']['image1']['id']:''); ?>">
                                                    <div  class="adminThumb">
                                        ...
                                        <div class="col-6">
                                            ...
                                            <div class="col-12">
                                                <form method="post" class="notGallery" action="<?php echo e(route('admin.homeSectionUpdate')); ?>" enctype="multipart/form-data">
                                                    ...
                                                    <input type="hidden" name="id" value="<?php echo e(isset($gallerySectionList['banner-bottom']['image1']['id'])?$gallerySectionList['banner-bottom']['image1']['id']:''); ?>">
                                                    <div  class="adminThumb">
                                        ...
                                        <div class="col-6">
                                            ...
                                            <div class="col-12">
                                                <form method="post" class="notGallery" action="<?php echo e(route('admin.homeSectionUpdate')); ?>" enctype="multipart/form-data">
                                                    ...
                                                    <input type="hidden" name="id" value="<?php echo e(isset($gallerySectionList['banner-bottom-text-1']['image1']['id'])?$gallerySectionList['banner-bottom-text-1']['image1']['id']:''); ?>">
                                                    <div  class="adminThumb">
                                        ...
                                        <div class="col-6">
                                            ...
                                            <div class="col-12">
                                                <form method="post" class="notGallery" action="<?php echo e(route('admin.homeSectionUpdate')); ?>" enctype="multipart/form-data">
                                                    ...
                                                    <input type="hidden" name="id" value="<?php echo e(isset($gallerySectionList['banner-bottom-text-2']['image1']['id'])?$gallerySectionList['banner-bottom-text-2']['image1']['id']:''); ?>">
                                                    <div  class="adminThumb">
                                        ...
                                        <div class="col-6">
                                            ...
                                            <div class="col-12">
                                                <form method="post" class="notGallery" action="<?php echo e(route('admin.homeSectionUpdate')); ?>" enctype="multipart/form-data">
                                                    ...
                                                    <input type="hidden" name="id" value="<?php echo e(isset($gallerySectionList['bullet1']['image1']['id'])?$gallerySectionList['bullet1']['image1']['id']:''); ?>">
                                                    <div  class="adminThumb">
                                        ...
                                        <div class="col-6">
                                            ...
                                            <div class="col-12">
                                                <form method="post" class="notGallery" action="<?php echo e(route('admin.homeSectionUpdate')); ?>" enctype="multipart/form-data">
                                                    ...
                                                    <input type="hidden" name="id" value="<?php echo e(isset($gallerySectionList['bullet2']['image1']['id'])?$gallerySectionList['bullet2']['image1']['id']:''); ?>">
                                                    <div  class="adminThumb">
                                                        <img class="img-fluid" id="bullet2" src="<?php echo e(isset($gallerySectionList['bullet2']['image1']['image'])?$gallerySectionList['bullet2']['image1']['image']!=''?asset( 'uploads/img/'.$gallerySectionList['bullet2']['image1']['image']):'':asset( 'backend/img/default/no-image.png')); ?>" alt="">
                                                    </div>
                                                    <div class="custom-file login-box"  style="margin-bottom: 10px; display: block;">
                                                        <input type="file" name="file" class="custom-file-input" >
                                                        <label class="custom-file-label" for="customFile">Choose file</label>
                                        ...
                                        <div class="col-6">
                                            ...
                                            <div class="col-12">
                                                <form method="post" class="notGallery" action="<?php echo e(route('admin.homeSectionUpdate')); ?>" enctype="multipart/form-data">
                                                    ...
                                                    <input type="hidden" name="id" value="<?php echo e(isset($gallerySectionList['bullet3']['image1']['id'])?$gallerySectionList['bullet3']['image1']['id']:''); ?>">
                                                    <div  class="adminThumb">
                                                        <img class="img-fluid" id="bullet3" src="<?php echo e(isset($gallerySectionList['bullet3']['image1']['image'])?$gallerySectionList['bullet3']['image1']['image']!=''?asset( 'uploads/img/'.$gallerySectionList['bullet3']['image1']['image']):'':asset( 'backend/img/default/no-image.png')); ?>" alt="">
                                                    </div>
                                                    <div class="custom-file login-box"  style="margin-bottom: 10px; display: block;">
                                                        <input type="file" name="file" class="custom-file-input" >
                                                        <label class="custom-file-label" for="customFile">Choose file</label>
                                        ...
                                        <div class="col-6">
                                            ...
                                            <div class="col-12">
                                                <form method="post" class="notGallery" action="<?php echo e(route('admin.homeSectionUpdate')); ?>" enctype="multipart/form-data">
                                                    ...
                                                    <input type="hidden" name="id" value="<?php echo e(isset($gallerySectionList['bullet4']['image1']['id'])?$gallerySectionList['bullet4']['image1']['id']:''); ?>">
                                                    <div  class="adminThumb">
                                                        <img class="img-fluid" id="bullet4" src="<?php echo e(isset($gallerySectionList['bullet4']['image1']['image'])?$gallerySectionList['bullet4']['image1']['image']!=''?asset( 'uploads/img/'.$gallerySectionList['bullet4']['image1']['image']):'':asset( 'backend/img/default/no-image.png')); ?>" alt="">
                                                    </div>
                                                    <div class="custom-file login-box"  style="margin-bottom: 10px; display: block;">
                                                        <input type="file" name="file" class="custom-file-input" >
                                                        <label class="custom-file-label" for="customFile">Choose file</label>
                                        ...
                                        <div class="col-6">
                                            ...
                                            <div class="col-8">
                                                <form method="post" class="notGallery" action="<?php echo e(route('admin.homeSectionUpdate')); ?>" enctype="multipart/form-data">
                                                    ...
                                                    <input type="hidden" name="id" value="<?php echo e(isset($gallerySectionList['bullet-bottom-left-top']['image1']['id'])?$gallerySectionList['bullet-bottom-left-top']['image1']['id']:''); ?>">
                                                    <div  class="adminThumb">
                                        ...
                                        <div class="col-6">
                                            ...
                                            <div class="col-12">
                                                <form method="post" class="notGallery" action="<?php echo e(route('admin.homeSectionUpdate')); ?>" enctype="multipart/form-data">
                                                    ...
                                                    <input type="hidden" name="id" value="<?php echo e(isset($gallerySectionList['bullet-bottom-left-bottom']['image1']['id'])?$gallerySectionList['bullet-bottom-left-bottom']['image1']['id']:''); ?>">
                                                    <div  class="adminThumb">
                                        ...
                                        <div class="col-6">
                                            ...
                                            <div class="col-12">
                                                <form method="post" class="notGallery" action="<?php echo e(route('admin.homeSectionUpdate')); ?>" enctype="multipart/form-data">
                                                    ...
                                                    <input type="hidden" name="id" value="<?php echo e(isset($gallerySectionList['bullet-bottom-right']['image1']['id'])?$gallerySectionList['bullet-bottom-right']['image1']['id']:''); ?>">
                                                    <div  class="adminThumb">
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                <form method="post" class="notGallery" action="<?php echo e(route('admin.homeSectionUpdate')); ?>" enctype="multipart/form-data">
                                                            ...
                                                            <input type="hidden" name="id" value="<?php echo e(isset($gallerySectionList['management1']['image1']['id'])?$gallerySectionList['management1']['image1']['id']:''); ?>">
                                                            <div class="form-group">
                                                                <input class="form-control" name="title" placeholder="Title" value="<?php echo e(isset($gallerySectionList['management1']['image1']['title'])?$gallerySectionList['management1']['image1']['title']:''); ?>" />
                                                            </div>
                                                            <div class="form-group">
                                                                <input class="form-control" name="designation" placeholder="Designation" value="<?php echo e(isset($gallerySectionList['management1']['image1']['designation'])?$gallerySectionList['management1']['image1']['designation']:''); ?>" />
                                                            </div>
                                                            <div class="form-group">
                                                                <textarea class="form-control" name="description" placeholder="Description"><?php echo e(isset($gallerySectionList['management1']['image1']['description'])?$gallerySectionList['management1']['image1']['description']:''); ?></textarea>
                                                            </div>
                                                            <div  class="adminThumb">
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                <form method="post" class="notGallery" action="<?php echo e(route('admin.homeSectionUpdate')); ?>" enctype="multipart/form-data">
                                                    ...
                                                    <input type="hidden" name="id" value="<?php echo e(isset($gallerySectionList['management2']['image1']['id'])?$gallerySectionList['management2']['image1']['id']:''); ?>">
                                                    <div class="form-group">
                                                        <input class="form-control" name="title" placeholder="Title" value="<?php echo e(isset($gallerySectionList['management2']['image1']['title'])?$gallerySectionList['management2']['image1']['title']:''); ?>" />
                                                    </div>
                                                    <div class="form-group">
                                                        <input class="form-control" name="designation" placeholder="Designation" value="<?php echo e(isset($gallerySectionList['management2']['image1']['designation'])?$gallerySectionList['management2']['image1']['designation']:''); ?>" />
                                                    </div>
                                                    <div class="form-group">
                                                        <textarea class="form-control" name="description" placeholder="Description"><?php echo e(isset($gallerySectionList['management2']['image1']['description'])?$gallerySectionList['management2']['image1']['description']:''); ?></textarea>
                                                    </div>
                                                    <div  class="adminThumb">
                                            ...
                                            <div class="col-6">
                                                ...
                                                <div class="col-12">
                                                    <form method="post" class="notGallery" action="<?php echo e(route('admin.homeSectionUpdate')); ?>" enctype="multipart/form-data">
                                                        ...
                                                        <input type="hidden" name="id" value="<?php echo e(isset($gallerySectionList['management2-signature']['image1']['id'])?$gallerySectionList['management2-signature']['image1']['id']:''); ?>">
                                                        <div  class="adminThumb">
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                <form method="post" class="notGallery" action="<?php echo e(route('admin.homeSectionUpdate')); ?>" enctype="multipart/form-data">
                                                    ...
                                                    <input type="hidden" name="id" value="<?php echo e(isset($gallerySectionList['management3']['image1']['id'])?$gallerySectionList['management3']['image1']['id']:''); ?>">
                                                    <div class="form-group">
                                                        <input class="form-control" name="title" placeholder="Title" value="<?php echo e(isset($gallerySectionList['management3']['image1']['title'])?$gallerySectionList['management3']['image1']['title']:''); ?>" />
                                                    </div>
                                                    <div class="form-group">
                                                        <input class="form-control" name="designation" placeholder="Designation" value="<?php echo e(isset($gallerySectionList['management3']['image1']['designation'])?$gallerySectionList['management3']['image1']['designation']:''); ?>" />
                                                    </div>
                                                    <div class="form-group">
                                                        <textarea class="form-control" name="description" placeholder="Description"><?php echo e(isset($gallerySectionList['management3']['image1']['description'])?$gallerySectionList['management3']['image1']['description']:''); ?></textarea>
                                                    </div>
                                                    <div  class="adminThumb">
                                            ...
                                            <div class="col-6">
                                                ...
                                                <div class="col-12">
                                                    <form method="post" class="notGallery" action="<?php echo e(route('admin.homeSectionUpdate')); ?>" enctype="multipart/form-data">
                                                        ...
                                                        <input type="hidden" name="id" value="<?php echo e(isset($gallerySectionList['management3-signature']['image1']['id'])?$gallerySectionList['management1-signature']['image1']['id']:''); ?>">
                                                        <div  class="adminThumb">
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                <form method="post" class="notGallery" action="<?php echo e(route('admin.homeSectionUpdate')); ?>" enctype="multipart/form-data">
                                                    ...
                                                    <input type="hidden" name="id" value="<?php echo e(isset($gallerySectionList['management4']['image1']['id'])?$gallerySectionList['management4']['image1']['id']:''); ?>">
                                                    <div class="form-group">
                                                        <input class="form-control" name="title" placeholder="Title" value="<?php echo e(isset($gallerySectionList['management4']['image1']['title'])?$gallerySectionList['management4']['image1']['title']:''); ?>" />
                                                    </div>
                                                    <div class="form-group">
                                                        <input class="form-control" name="designation" placeholder="Designation" value="<?php echo e(isset($gallerySectionList['management4']['image1']['designation'])?$gallerySectionList['management4']['image1']['designation']:''); ?>" />
                                                    </div>
                                                    <div class="form-group">
                                                        <textarea class="form-control" name="description" placeholder="Description"><?php echo e(isset($gallerySectionList['management4']['image1']['description'])?$gallerySectionList['management4']['image1']['description']:''); ?></textarea>
                                                    </div>
                                                    <div  class="adminThumb">
                                            ...
                                            <div class="col-6">
                                                ...
                                                <div class="col-12">
                                                    <form method="post" class="notGallery" action="<?php echo e(route('admin.homeSectionUpdate')); ?>" enctype="multipart/form-data">
                                                        ...
                                                        <input type="hidden" name="id" value="<?php echo e(isset($gallerySectionList['management4-signature']['image1']['id'])?$gallerySectionList['management1-signature']['image1']['id']:''); ?>">
                                                        <div  class="adminThumb">
                                                            <img class="img-fluid" id="management4-signature" src="<?php echo e(isset($gallerySectionList['management4-signature']['image1']['image'])?$gallerySectionList['management4-signature']['image1']['image']!=''?asset( 'uploads/img/'.$gallerySectionList['management4-signature']['image1']['image']):'':asset( 'backend/img/default/no-image.png')); ?>" alt="">
                                                        </div>
                                                        <div class="custom-file login-box"  style="margin-bottom: 10px; display: block;">
                                                            <input type="file" name="file" class="custom-file-input" >
                                                            <label class="custom-file-label" for="customFile">Choose file</label>
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                <form method="post" class="notGallery" action="<?php echo e(route('admin.homeSectionUpdate')); ?>" enctype="multipart/form-data">
                                                    ...
                                                    <input type="hidden" name="id" value="<?php echo e(isset($gallerySectionList['management5']['image1']['id'])?$gallerySectionList['management5']['image1']['id']:''); ?>">
                                                    <div class="form-group">
                                                        <input class="form-control" name="title" placeholder="Title" value="<?php echo e(isset($gallerySectionList['management5']['image1']['title'])?$gallerySectionList['management5']['image1']['title']:''); ?>" />
                                                    </div>
                                                    <div class="form-group">
                                                        <input class="form-control" name="designation" placeholder="Designation" value="<?php echo e(isset($gallerySectionList['management5']['image1']['designation'])?$gallerySectionList['management5']['image1']['designation']:''); ?>" />
                                                    </div>
                                                    <div class="form-group">
                                                        <textarea class="form-control" name="description" placeholder="Description"><?php echo e(isset($gallerySectionList['management5']['image1']['description'])?$gallerySectionList['management5']['image1']['description']:''); ?></textarea>
                                                    </div>
                                                    <div  class="adminThumb">
                                                        <img class="img-fluid" id="management5" src="<?php echo e(isset($gallerySectionList['management5']['image1']['image'])?$gallerySectionList['management1']['image1']['image']!=''?asset( 'uploads/img/'.$gallerySectionList['management5']['image1']['image']):'':asset( 'backend/img/default/no-image.png')); ?>" alt="">
                                                        <p class="cs-text-desc">N.B: Recommended size = 412X410 px</p>
                                                    </div>
                                                    <div class="custom-file login-box"  style="margin-bottom: 10px; display: block;">
                                                        <input type="file" name="file" class="custom-file-input" >
                                            ...
                                            <div class="col-6">
                                                ...
                                                <div class="col-12">
                                                    <form method="post" class="notGallery" action="<?php echo e(route('admin.homeSectionUpdate')); ?>" enctype="multipart/form-data">
                                                        ...
                                                        <input type="hidden" name="id" value="<?php echo e(isset($gallerySectionList['management5-signature']['image1']['id'])?$gallerySectionList['management5-signature']['image1']['id']:''); ?>">
                                                        <div  class="adminThumb">
                                                            <img class="img-fluid" id="management5-signature" src="<?php echo e(isset($gallerySectionList['management5-signature']['image1']['image'])?$gallerySectionList['management5-signature']['image1']['image']!=''?asset( 'uploads/img/'.$gallerySectionList['management5-signature']['image1']['image']):'':asset( 'backend/img/default/no-image.png')); ?>" alt="">
                                                        </div>
                                                        <div class="custom-file login-box"  style="margin-bottom: 10px; display: block;">
                                                            <input type="file" name="file" class="custom-file-input" >
                                                            <label class="custom-file-label" for="customFile">Choose file</label>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vagrant/sites/dev.mangrove-hotel/resources/views/admin/cmsfront/aboutus.blade.php ENDPATH**/ ?>