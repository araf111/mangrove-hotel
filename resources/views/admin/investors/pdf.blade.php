                ...
                <td style="width:40%;"></td>
                    <td style="width:50%;">
                        ...
                        <table>
                            <tr>
                                <td></td>
                                <td style="text-align:left;padding-bottom:7px"><img src="{{asset($profile_picture)}}" width="110px" height="130px">
                                </td>
                                <td></td>
                                <td></td>
                                ...
                                <td style="vertical-align:top;">
                                    <table width="100%">
                                        <tr>
                                            ...
                                            <td class="field-border">{{$investor->investor_id}}</td>
                                        </tr>
                                    </table>
        ...
        <table style="width:100%;margin-top:40px;" cellspacing="10px;">
            <tr>
                <td style="width:200px;height:60px;vertical-align:bottom;border:1px solid #000;text-align:center">
                    <p style="padding:0;margin:0px">{{$investor->dealing_person}}</p>
                    <p style="padding:0;margin:0px">{{$investor->dealing_person_designation}}</p>
                    <p style="padding:0;margin:0px">{{$investor->dealing_person_office_id}}</p>
