                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <label for="room_type">Room Type</label>
                                 {{Form::text('room_type', null, array('class' => "form-control",'id'=>'room_type','placeholder'=>'Room Type', 'required' => 'required', 'maxlength' => '50'))}}
                            ...
                            <div class="form-group">
                                ...
                                {{Form::text('installment_amount', null, array('class' => "form-control",'placeholder'=>'Installment Amount', 'required' => 'required','id'=>'installment_amount'))}}
                            ...
                            <div class="form-group">
                                ...
                                {{Form::text('installment_number',null, array('class' => "form-control",'placeholder'=>'Installment Number', 'required' => 'required','id'=>'installment_number'))}}
