...
<section class="content">
    <div class="card card-solid">
        ...
        <div class="row no-print">
            <div class="col-12">
                <a type="button" class="btn btn-primary float-right" style="margin-right: 5px;" href="{{route('admin.investor.generateInvoice', $investor->iid)}}"><i class="fas fa-download"></i>Print Invoice</a>
            </div>
        </div>
    </div>
