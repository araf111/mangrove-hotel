...
{{--                                </div>--}}
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="peradd">Address1(Permanent Address)</label>
                                        {{Form::text('peradress', null, array('class' => "form-control",'id'=>'','placeholder'=>'H# 222, Plot# 3633, R# 120, Vill# XYZ', 'required' => 'required', 'maxlength' => '150'))}}

                                        @if ($errors->has('peradress'))
                                        <span class="text-danger">{{ $errors->first('peradress') }}</span>
                                        @endif
                                    </div>
                                </div>
                              </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="paddress">Address2(Present Address)</label>
                                            {{Form::text('present_address', null, array('class' => "form-control",'id'=>'','placeholder'=>'H# 222, Plot# 3633, R# 120, Vill# XYZ', 'required' => 'required', 'maxlength' => '150'))}}
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="officeaddress">Address3(Office Address)</label>
                                        {{Form::text('office_address', null, array('class' => "form-control",'id'=>'','placeholder'=>'H# 222, Plot# 3633, R# 120, Vill# XYZ', 'required' => 'required', 'maxlength' => '150'))}}
                ...
                <div class="row">
                    <div class="col-lg-8 col-md-8 col-sm-12">
                        <div class="col-12" style="padding:0;">
                            <div class="form-group">
                                <label for="paymentshedulemode">Payment Shedule Mode</label>
                                {{Form::text('payment_shedule_mode', null, array('class' => "form-control",'id'=>'','placeholder'=>'Payment Shedule Mode', 'required' => 'required', 'maxlength' => '150'))}}
