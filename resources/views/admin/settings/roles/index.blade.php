               ...
               <div class="card">
                  ...
                  <div class="card-body">                     
                     ...
                     <div class="form-group">
                           ...
                           <input type="text" class="form-control" name="name" value="{{ old('name') }}" placeholder="Write the Role ...">
                     </div>
                     <div class="form-group">
                           <label>Display Name</label>
                           <input type="text" class="form-control" name="label" value="{{ old('label') }}" placeholder="Display Name...">
                     </div>
                     <!-- Minimal style -->
                     <div class="row">
                           ...
                           <div class="card-body">
                              <div class="form-group">
                                    ...
                                    <div class="icheck-primary d-inline col-md-4">
                                       <input type="checkbox" name="permission[]" value="{{$permission->id}}" id="checkboxPrimary{{$permission->id}}">
