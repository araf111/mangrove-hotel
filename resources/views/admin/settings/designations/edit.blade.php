        ...
        <div class="row">
            <div class="col-md-6">
                <div class="card">
                    ...
                    <form method="POST" action="{{ route('admin.designations.update', [$designationObj->id]) }}">
                    @method('PUT')
                    @csrf
                    <!-- /.card-header -->
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="name" value="{{ $designationObj->name }}">
                        </div>
                        <div class="form-group">
                            ...
                            <select class="form-control select2bs4" name="department_id">
                                ...
                                <option value="{{ $department->id }}" @if($department->id == $designationObj->department_id) selected="selected" @endif >{{$department->name}}</option>
                                @endforeach 
                            </select>
                        </div>
                        <div class="form-group">
                            ...
                            <select class="form-control select2bs4" name="top_designation_id">
                                ...
                                <option value="{{ $designation->id }}" @if($designation->id == $designationObj->top_designation_id) selected="selected" @endif >{{ $designation->name }}</option>
                                @endforeach     
                            </select>
                        </div>
                        <div class="form-group">
