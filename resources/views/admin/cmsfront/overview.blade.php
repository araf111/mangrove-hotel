                            ...
                            <div class="tab-pane text-left fade show active" id="vert-tabs-overview-1" role="tabpanel" aria-labelledby="vert-tabs-overview-1-tab">
                              <div class="card-body">
                                 <div class="row" style="margin-bottom: 20px; padding-bottom: 20px"; >
                                    ...
                                    <div class="col-8">
                                        <form method="post" class="overview" action="{{ route('admin.homeSectionUpdate') }}" enctype="multipart/form-data">
                                            @csrf
                                            <input type="hidden" name="id_to_display" value="overview_topleftbanner">
                                            <input type="hidden" name="id" value="{{$overviewSectionList['Top left banner']['image1']['id']}}">
                                            <div class="adminThumb">
                                                <img class="img-fluid" id="overview_topleftbanner" src="{{$overviewSectionList['Top left banner']['image1']['image']!=''?asset('uploads/img/'.$overviewSectionList['Top left banner']['image1']['image']):asset( 'backend/img/default/no-image.png')}}" alt="User profile picture">
                                            </div>
                                 ...
                                 <div class="row" style="margin-bottom: 20px; padding-bottom: 20px"; >
                                    ...
                                    <div class="col-8">
                                        <form method="post" class="overview" action="{{ route('admin.homeSectionUpdate') }}" enctype="multipart/form-data">
                                            ...
                                            <input type="hidden" name="id" value="{{$overviewSectionList['Top right banner']['image1']['id']}}">
                                            <div class="form-group">
                                                <textarea class="form-control" name="description" rows="3" placeholder="Enter the Text">{{$overviewSectionList['Top right banner']['image1']['description']}}</textarea>
                                            </div>
                                            <div class="adminThumb">
                                                <img class="img-fluid"  id="overview_toprightbanner" src="{{$overviewSectionList['Top right banner']['image1']['image']!=''?asset('uploads/img/'.$overviewSectionList['Top right banner']['image1']['image']):asset( 'backend/img/default/no-image.png')}}" alt="User profile picture">
                                            </div>
                                            <div class="custom-file login-box"  style="margin-bottom: 10px; display: block;">
                                                <input type="file" name="file" class="custom-file-input" >
                                                <label class="custom-file-label" for="customFile">Choose file</label>
                                 ...
                                 <div class="row" style="margin-bottom: 20px; padding-bottom: 20px"; >
                                    ...
                                    <div class="col-8">
                                        <form method="post" class="overview" action="{{ route('admin.homeSectionUpdate') }}" enctype="multipart/form-data">
                                            ...
                                            <input type="hidden" name="id" value="{{$overviewSectionList['Bottom left banner']['image1']['id']}}">
                                                <div class="adminThumb">
                                                    <img class="img-fluid" id="bottomLeftBanner" src="{{$overviewSectionList['Bottom left banner']['image1']['image']!=''?asset('uploads/img/'.$overviewSectionList['Bottom left banner']['image1']['image']):asset( 'backend/img/default/no-image.png')}}" alt="User profile picture">
                                                </div>
                                                <div class="custom-file login-box"  style="margin-bottom: 10px; display: block;">
                                                    <input type="file" name="file" class="custom-file-input" >
                                                    <label class="custom-file-label" for="customFile">Choose file</label>
                                 ...
                                 <div class="row" style="margin-bottom: 20px; padding-bottom: 20px"; >
                                    ...
                                    <div class="col-8">
                                        <form method="post" class="overview" action="{{ route('admin.homeSectionUpdate') }}" enctype="multipart/form-data">
                                            ...
                                            <input type="hidden" name="id" value="{{$overviewSectionList['Bottom right banner']['image1']['id']}}">
                                            <div class="form-group">
                                                <input class="form-control" name="description" value="{{$overviewSectionList['Bottom right banner']['image1']['description']}}"  placeholder="Enter the url"/>
                                            </div>
                                            <div class="adminThumb">
                                                <img class="img-fluid" id="bottomRightBanner" src="{{$overviewSectionList['Bottom right banner']['image1']['image']!=''?asset('uploads/img/'.$overviewSectionList['Bottom right banner']['image1']['image']):asset( 'backend/img/default/no-image.png')}}" alt="User profile picture">
                                            </div>
                                            <div class="custom-file login-box"  style="margin-bottom: 10px; display: block;">
                                                <input type="file" name="file" class="custom-file-input" >
                                                <label class="custom-file-label" for="customFile">Choose file</label>
                                    ...
                                    <div class="row" style="margin-bottom: 20px; padding-bottom: 20px"; >
                                        ...
                                        <div class="col-8">
                                            <form method="post" class="overview" action="{{ route('admin.homeSectionUpdate') }}" enctype="multipart/form-data">
                                                ...
                                                <input type="hidden" name="id" value="{{isset($overviewSectionList['coverStory']['image1']['id'])?$overviewSectionList['coverStory']['image1']['id']:''}}">

                                                <div class="adminThumb">
                                                    <img class="img-fluid" id="coverStory" src="{{isset($overviewSectionList['coverStory']['image1']['image'])?$overviewSectionList['coverStory']['image1']['image']!=''?asset('uploads/img/'.$overviewSectionList['coverStory']['image1']['image']):'':asset( 'backend/img/default/no-image.png')}}" alt="User profile picture">
                                                </div>
                                                <div class="custom-file login-box"  style="margin-bottom: 10px; display: block;">
                                                    <input type="file" name="file" class="custom-file-input" >
                                                    <label class="custom-file-label" for="customFile">Choose file</label>
