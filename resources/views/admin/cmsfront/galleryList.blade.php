                        ...
                        <div class="row" style="margin-bottom: 20px; padding-bottom: 20px"; >
                            ...
                            <div class="col-8">
                                <form method="post" class="notGallery" action="{{ route('admin.homeSectionUpdate') }}" enctype="multipart/form-data">
                                    @csrf
                                    <input type="hidden" name="id" value="{{isset($gallerySectionList['createdBy']['text']['id'])?$gallerySectionList['createdBy']['text']['id']:''}}">
                                    <div class="form-group">
                                        <textarea class="form-control" name="content" rows="3" placeholder="Enter the Text">{{isset($gallerySectionList['createdBy']['text']['description'])?$gallerySectionList['createdBy']['text']['description']:''}}</textarea>
                                    </div>
                        ...
                        <div class="row" style="margin-bottom: 20px; padding-bottom: 20px"; >
                            ...
                            <div class="col-8">
                                <form method="post" class="notGallery" action="{{ route('admin.homeSectionUpdate') }}" enctype="multipart/form-data">
                                    ...
                                    <input type="hidden" name="id" value="{{isset($gallerySectionList['studio']['logo']['id'])?$gallerySectionList['studio']['logo']['id']:''}}">
                                    <div class="adminThumb">
                                        <img class="img-fluid" id="logo" src="
                                        {{  isset($gallerySectionList['studio']['logo']['image'])?$gallerySectionList['studio']['logo']['image']!=''?asset( 'uploads/img/'.$gallerySectionList['studio']['logo']['image']):'':asset( 'backend/img/default/no-image.png')  }}" alt="User profile picture">
                                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-8">
                                <form method="post" class="notGallery" action="{{ route('admin.homeSectionUpdate') }}" enctype="multipart/form-data">
                                    ...
                                    <input type="hidden" name="id" value="{{isset($gallerySectionList['3D']['logo']['id'])?$gallerySectionList['3D']['logo']['id']:''}}">
                                    <div  class="adminThumb">
                                        <img class="img-fluid" id="favicon" src="{{ isset($gallerySectionList['3D']['logo']['image'])?$gallerySectionList['3D']['logo']['image']!=''?asset( 'uploads/img/'.$gallerySectionList['3D']['logo']['image']):'':asset( 'backend/img/default/no-image.png')  }}" alt="User profile picture">
                                    </div>
                                    <div class="custom-file login-box"  style="margin-bottom: 10px; display: block;">
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-footer">
                        <a  class="btn btn-warning float-right" href="{{route('admin.cms.gallery')}}">Add New Image</a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="card card-default">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                <a type="button" class="btn btn-tool"  href="{{route('admin.cms.removeGallery',['id'=>$item->id])}}" onclick="return confirm('Are you sure?')"><i class="far fa-trash-alt"></i></a>
                            </div>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body" style="display: block;">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="card-body">
                                                <div class="form-group">
                                                    <label for="inputName">Image Title:{{$item->title}}</label>

                                                </div>
                                                <div class="form-group">
                                                    <label for="inputDescription">Image Description:{{$item->description}}</label>
